...
namespace ProdigalArchipelago
{
    ...
    class CastleSailor : MonoBehaviour
    {
        ...
        public void Chat()
        {
            List<GameMaster.Speech> chatter = new() {
                GameMaster.CreateSpeech(31, 0, "WANT TO GO TO BJERG CASTLE?", "SAILOR", 0),
            };
        ...
        public void Reply(bool Yes)
        {
            ...
            {
                List<GameMaster.Speech> chatter = new() {
                    GameMaster.CreateSpeech(31, 0, "YEAH, I WOULDN'T WANT TO EITHER.", "SAILOR", 0),
                };
    ...
    class Molly_ProposalEvent_Patch
    {
        static IEnumerator Postfix(IEnumerator __result, Molly __instance)
        {
            ...
            if (Archipelago.Enabled)
            {
                ...
                {
                    __instance.StartCoroutine((IEnumerator)AccessTools.Method(typeof(Molly), "MarryMe").Invoke(__instance, new object[] {}));
                }
            }
        }
    }
