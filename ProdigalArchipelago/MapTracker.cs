    ...
    private void SetupDots()
    {
        Dots = [
            ...
            TrackerDot.NewDot("Tidal Mines", 43, -52, true, () => Item.RustyKey.Acquired(), [
                ...
                new TrackerLocation("Deep - Turtles Chest", 97, () => HasHand2() && HasLariat() && HasPick() && HasKnuckle() && HasKey(Key.TidalMines, 3),
                    () => HasHand2() && HasLariat() && HasPick() && HasKnuckle() && CanOpen(Key.TidalMines, 40)),
                new TrackerLocation("Deep - Water Blessing", 230, () => HasHand2() && HasLariat() && HasPick() && HasKnuckle() && HasKey(Key.TidalMines, 4),
                    () => HasHand2() && HasLariat() && HasPick() && HasKnuckle() && CanOpen(Key.TidalMines, 40, 41)),
            ]),
